...
# player
playerImg = pygame.image.load('images/playerr.png')
playerX = 360
playerY = 480
playerX_change = 0
playerY_change = 0
...
def player(x, y):
    screen.blit(playerImg,(x, y)) #Drawing player img on screen

def enemy(x, y, i):
    screen.blit(enemyImg[i],(x, y)) #Drawing enemy img on screen   
...
while running:
    ...
    if event.type == pygame.KEYDOWN:
        ...
        if event.key == pygame.K_SPACE:
            if bullet_state is "ready":
                ...
                # Get the cuurent x coordinate of the spaceship
                bulletX = playerX
    ...
    # Checking the Boundary so it doesn't go out of bound
